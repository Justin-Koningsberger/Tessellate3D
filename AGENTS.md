...
* **CRITICAL:** All internal module imports within source dependencies must include explicit, valid `.ts` file extensions.
* *Example:* `import { forward } from './transforms/forward.ts';`
