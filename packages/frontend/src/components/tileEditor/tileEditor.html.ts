...
export const tileEditorTemplate = `
  <div id="customTileModal" class="custom-modal-backdrop">
    <div id="custom-modal-container" class="custom-modal-container">
      ...
      <div id="editorLayoutWrapper" class="layout-compact-active">

        <!-- 1. COMPACT VIEW PANEL CONTAINER -->
        <div class="view-compact-block">
          <div class="compact-header-row">
            <h2 class="compact-title">Symmetric Motif Vector Editor</h2>
          </div>

          <!-- TOP ROW BUTTONS -->
          <div class="compact-mode-controls">
            <!-- DEFORM/DRAW SLIDER SWITCH OVAL -->
            <div class="touch-pill-row">
              <div class="canvas-overlay-switch compact-switch-overlay">
          ...
          <p class="compact-shortcuts">
            <span class="key-hint-cyan">Alt + Click</span> to add a node handle.
            <span class="key-hint-coral">Shift + Click</span> to remove a handle.
          </p>

          <div class="mobile-deform-toolbar">
          ...
          <!-- COMPACT LAYOUT DRAWING ACTIONS ROW -->
          ...
          <!-- COMPACT VIEW CANVAS ANCHOR ZONE -->
          <div id="mountCompact" class="canvas-mount-zone"></div>

          <!-- COMPACT VIEW LATTICE DROPED SELECTION GRID SYSTEM -->
        ...
        <div class="view-maximized-grid">
          <div class="editor-canvas-viewport">
            <div class="editor-canvas-container" style="position: relative;">
              ...
              <div id="mountMaximized" class="canvas-stretch-mount"></div>
            </div>
          </div>
            ...
            <div id="sidebarActualContent" class="sidebar-content-loaded" style="display: none;">
              <div>
                ...
                <div class="deform-instructions-block">
                  <p class="maximized-desc">Design a custom interlocking base motif.</p>
